...
class SharedFile(models.Model):
    ...
    user_id = models.ForeignKey(User, null=True, blank=True, verbose_name='Загрузивший пользователь', on_delete=models.CASCADE)
    ...
    privately_accessed = models.ManyToManyField(to=User, related_name='private_files', verbose_name='Приватный доступ')
